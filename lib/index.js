...
module.exports = function( twigInstance ) {
  ...
  return twigInstance.extend( function(){
    ...
    /* Take an unformatted phone number and make it look pretty for peoples eyes.
     * @example
     * {{varName|phone}}
     */
    twigInstance.extendFilter('phone', function(input) {
      return '(' + input.slice(0, 3) + ') ' + input.slice(3, 3) + '-' + input.slice(6, 4);
    });
  });
};
